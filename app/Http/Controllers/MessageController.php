        ...
        if ($message->chat1 && $message->chat2) {
            return response()->json([
                'error' => '<div class="space-y-2">
                                <div class="w-full pb-2 border-b-2 flex items-center text-sm font-medium text-blue31 space-x-1">
                                    <svg class="size-5 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
