...
class AsessmentController extends Controller
{
    ...
    public function asessmentHistoryUser(Request $request)
    {
        ...
        if (!in_array($asessmentId, [1, 2])) {
            return abort(404, 'Invalid assessment ID');
        }    
        ...
        // Untuk Penilaian I, kita tampilkan page2_0
        if ($asessmentId == 1) {
        ...
        // Untuk Penilaian II, kita tampilkan page8_0
        elseif ($asessmentId == 2) {
        ...
        // Jika tidak ditemukan asessment_id, beri error
