                    ...
                    <div class="home-shadow-content">
                        <form id="banner_image" action="{{ route('profile-media-update') }}" method="POST" enctype="multipart/form-data">    
                            ...
                            <div class="flex items-start justify-end">    
                                ...
                                <img id="photo-preview" src="{{ $profile->banner_image ? asset('storage/' . $profile->banner_image) : asset('images/samplebg.jpg') }}" alt="" class="w-full h-80 object-cover rounded">    
                            ...
                            <div class="text-lg text-blue31 flex justify-center items-center w-full h-fit rounded-xl">
                                <div class="flex w-full p-3 gap-8">
                                    <div class="w-1/4 h-fit pb-4 py-1 space-y-5 bg-white flex flex-col justify-center items-center">  
                                        <form id="profile_image" action="{{ route('profile-media-update') }}" method="POST" enctype="multipart/form-data" class="w-full flex flex-col items-center justify-center">    
                                            @csrf    
                                            @method('PUT')    
                                            <div class="w-5/6 h-fit flex flex-col items-center justify-center">    
                                                <div class="w-full h-80 relative overflow-hidden bg-bluee3 border-2 border-blue31 rounded">    
                                        ...
                                        <div class="w-5/6 h-fit font-medium space-y-4">  
                                            <div class="border-b-2 border-bluee3 pb-5">  
                                                <h1 id="username" class="text-2xl font-extrabold">{{ old('username', $profile->username) }}</h1>  
                                                <h5 id="occupation" class="text-xl">{{ old('occupation', $profile->occupation) }}</h5>  
                                                <h5 id="institution" class="text-xl">{{ old('institution', $profile->institution) }}</h5>  
                                            </div>  
                                            <form id="description" action="{{ route('profile-media-update') }}" method="POST">  
                                                ...
                                                <div id="description-container" class="flex flex-col space-y-1">  
                                                    ...
                                                    <button type="button" id="edit-button" class="px-4 py-1 border-2 border-blue31 rounded hover:bg-blue31 hover:text-white font-medium text-base">Tambahkan Deskripsi</button>  
                                                </div>  
