                ...
                <div class="w-full h-auto flex-col text-blue31">
                    <div class="home-shadow-content">
                        <div class="flex items-start justify-end">  
                            ...
                            <img id="photo-preview" src="{{ asset($profile->banner_image ?? 'images/samplebg.jpg') }}" alt="" class="w-full h-80 object-cover rounded">  
                        </div> 
                                    ...
                                    <div class="w-1/4 h-fit pb-4 py-1 space-y-5 bg-white flex flex-col justify-center items-center ">  
                                        <div class="w-5/6 h-fit flex flex-col items-center justify-center">  
                                            <div class="w-full h-64 relative overflow-hidden bg-bluee3 border-2 border-blue31">  
                                                <img id="profile-image" src="{{ asset($profile->profile_image ?? 'images/profile-sample.jpg') }}" alt="Profile Image" class="object-cover w-full h-full">  
                                            </div>  
                                        ...
                                        <div class="w-5/6 h-fit font-medium space-y-4">  
                                            <div class="border-b-2 border-bluee3 pb-5">  
                                                <h1 id="username" class="text-2xl font-extrabold">{{ $profile->username }}</h1>  
                                                <h5 id="occupation" class="font-medium">{{ $profile->occupation }}</h5>  
                                                <h5 id="institution" class="font-medium">{{ $profile->institution }}</h5>  
                                            </div>  
                                            ...
                                            <div class="pt-3 text-sm font-bold">  
                                                <div class="w-full px-4 py-2 flex justify-center items-center cursor-pointer bg-pinkee text-white rounded transition hover:bg-blue31">  
                                                        ...
                                                        <div class="w-full flex">  
                                                            <div class="flex-col w-full text-start space-y-4 font-medium">  
                                                                <div class="space-y-1">  
                                                                    ...
                                                                    <input type="text" name="first_name" value="{{ $profile->first_name }}" class="p-2 w-full border-2 border-bluee3 rounded focus:outline-none focus:ring-2 focus:ring-blue31" required>  
                                                                </div>  
                                                                <div class="space-y-1">  
                                                                    <label>Tempat dan Tanggal Lahir</label>  
                                                                    <input type="text" name="birth_place" value="{{ $profile->birth_place }}" class="p-2 w-full border-2 border-bluee3 rounded focus:outline-none focus:ring-2 focus:ring-blue31" required>  
                                                                </div>  
                                                                <div class="space-y-1 flex-col w-full">  
                                                                    <label>Alamat Lengkap</label>  
                                                                    <input type="text" name="address" value="{{ $profile->address }}" class="p-2 w-full border-2 border-bluee3 rounded focus:outline-none focus:ring-2 focus:ring-blue31" required>  
                                                                </div>  
                                                                <div class="space-y-1">  
                                                                    <label>Nomor Telpon</label>  
                                                                    <input type="tel" name="phone" value="{{ $profile->phone }}" class="p-2 w-full border-2 border-bluee3 rounded focus:outline-none focus:ring-2 focus:ring-blue31" required>  
                                                                </div>  
                                                            </div>  
                                                        </div>  
                                                        <div class="w-full flex">  
                                                            <div class="flex-col w-full text-start space-y-4 font-medium">  
                                                                <div class="space-y-1">  
                                                                    ...
                                                                    <input type="text" name="last_name" value="{{ $profile->last_name }}" class="p-2 w-full border-2 border-bluee3 rounded focus:outline-none focus:ring-2 focus:ring-blue31" required>  
                                                                </div>  
                                                                <div class="space-y-1">  
                                                                    <label class="text-transparent">Tanggal Lahir</label>  
                                                                    <input type="date" name="birth_date" value="{{ $profile->birth_date }}" class="w-full p-1.5 border-2 border-bluee3 rounded focus:outline-none focus:ring-2 focus:ring-blue31" required/>  
                                                                </div>  
                                                                <div class="space-y-1">  
                                                                ...
                                                                <div class="space-y-1">  
                                                                    <label>Email</label>  
                                                                    <input type="email" name="email" value="{{  old('email', $user->email) }}" class="p-2 w-full border-2 border-bluee3 rounded focus:outline-none focus:ring-2 focus:ring-blue31" required>  
                                                                </div>  
                                                            </div>  
                                                        </div>  
                                                    </div>  
                                                            ...
                                                            <div class="w-full flex">  
                                                                <div class="flex-col w-full text-start space-y-4 font-medium">  
                                                                    <div class="text-start space-y-1">  
                                                                        ...
                                                                        <select name="occupation" id="occupation" class="w-full p-2 border-2 border-bluee3 rounded focus:outline-none focus:ring-2 focus:ring-blue31" required>  
                                                                            <option value="{{ $profile->occupation }}">{{ $profile->occupation ?? 'Pilih Pekerjaan Anda...' }}</option>  
                                                            ...
                                                            <div class="w-full flex">  
                                                                <div class="flex-col w-full text-start space-y-4 font-medium">  
                                                                    <div class="space-y-1">  
                                                                        ...
                                                                        <input type="text" name="institution" value="{{ $profile->institution }}" class="w-full p-2 border-2 border-bluee3 rounded focus:outline-none focus:ring-2 focus:ring-blue31" required/>  
                                                                    </div>  
                                                                    <div class="space-y-1">  
                                                    ...
                                                    <div class="w-full h-4/5 p-4 space-y-3 border-2 border-l-8 border-bluee3">
                                                        <div class="w-full h-fit flex">
                                                            ...
                                                            <div class="w-1/5 text-center flex items-center justify-center">
                                                                <a href="" class="text-center font-medium text-base py-1 px-10 bg-blue31 text-white rounded hover:bg-transparent hover:text-blue31 hover:border-2 hover:border-blue31">
                                                                    Tinjau
                                                                </a>
                                                            </div>
                                                        </div>
...
document.addEventListener('DOMContentLoaded', function () {  
    ...
    // JS untuk notifikasi
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            //         credentials: 'include', // Sertakan cookie (jika digunakan)
            //     });
            ...
            //         height: 200,
            //     });
            //     sessionStorage.setItem('google2fa_secret', data.secret);
            // }
