            ...
            <div class="w-1/2 relative transform rounded bg-white shadow-xl transition-all sm:my-8 lg:w-[35%] lg:h-[90%]">
                <div class="w-full h-full flex flex-col items-center justify-start px-12 py-2 text-blue31 rounded">
                    ...
                    <div class="w-full h-fit text-center space-y-3">
                        <h3 class="text-3xl font-semibold">Selamat, telah Belajar!</h3>
                        <p class="opacity-80">Berikan ulasan dan rating dari proses pembelajaran yang telah dilakukan. Saran dan masukan Anda sangat membantu Kami dalam mengembangkan program pembelajaran yang lebih baik.</p>
                    </div>
