                    ...
                    <div class="h-full w-full mt-8 pl-8 space-y-8 overflow-y-scroll scrollbar scrollbar-thumb scrollbar-thumb-rounded scrollbar-thumb-gray-300 scrollbar-track-gray-100" style="direction: rtl;">
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full text-blue31 pb-4 border-b-2 border-bluee3 text-justify"  style="direction: ltr;">
                                <p class="mt-7 p-2 bg-bluee3"><span class="font-medium">Karakteristik Komunikasi Pragmatis</span> - Komunikasi Pragmatis Anak dengan Autimse</p>                        
                                <p class="mt-2 whitespace-pre-line">Hallo, selamat datang kembali di sesi lanjutan tentang komunikasi pada anak autisme, bersama dengan saya Retno. Sebelumnya kita telah membahas keterampilan pendahuluan, komunikasi reseptif, dan ekspresif, kini kita akan fokus pada komunikasi pragmatis. 

                                    <span class="font-medium">Komunikasi pragmatis</span> mengacu kepada penggunaan bahasa dalam konsteks sosial secara luas. Pada anak autisme, keterampilan ini sering menjadi tantangan karena kesulitan mereka memahami aturan sosial yang mengatur cara komunikasi sehari – hari.  Beberapa karakteristik dari komunikasi pragmatis adalah : 
                                </p>
                            ...
                            <div class="w-3/4 space-x-10 mt-8 flex justify-end items-center"  style="direction: ltr;">
                                <a href="/page4_2" class="text-base flex text-blue31 font-semibold">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" fill="#6AA4D9" viewBox="0 0 24 24">
                                ...
                                <a href="/page4_4" class="text-base flex text-blue31 font-semibold">Selanjutnya
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" fill="#6AA4D9" viewBox="0 0 24 24">
                                        <path d="M8.293 4.707a1 1 0 0 1 1.414 0L16.707 12l-6.293 7.293a1 1 0 0 1-1.414-1.414L14.586 12 8.293 6.121a1 1 0 0 1 0-1.414z" />
                                    </svg>
                                </a>
