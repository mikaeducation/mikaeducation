                        ...
                        <div class="space-y-4 border-2 border-bluee3" style="direction: ltr;">
                            <div class="w-full h-fit flex p-2 bg-bluee3">
                                <p class="text-base whitespace-pre-line"><span class="font-bold">Bagian 3 -</span> Kepuasan penggunaan MIKA Education sebagai sumber belajar
                                    Intruksi: <span class="font-medium">  Dari skala 1-5, sejauh mana kalimat-kalimat di bawah ini sesuai menggambarkan kepuasan Anda atas materi belajar di website MIKA education? </span>
                                </p>
                            </div>
                            <div class="w-full space-y-4 pl-2 pb-2 text-base">
                                <div class="w-full text-blue31">
                                    <p class="font-bold">B. Materi belajar MIKA education</p>
                                    <form action="/page9_3_3" method="" class="space-y-4">
                                        @csrf
                                        <!-- Pertanyaan 1 -->
                                        <div class="">
                                            <h2 class="mb-2">
                                                1. Materi yang diberikan sangat jelas dan mudah dimengerti
                                            </h2>
                                            @foreach([
                                        ...
                                        <div class="">
                                            <h2 class="mb-2">
                                                2. Contoh-contoh yang diberikan sangat relevan untuk saya terapkan pada pendidikan/terapi yang saya lakukan bersama anak
                                            </h2>
                                            @foreach([
                                                'Sama sekali tidak puas (1)',
                                                'Tidak terlalu puas (2)',
                                        ...
                                        <div class="">
                                            <h2 class="mb-2">
                                                3. Bacaan yang diberikan relevan bagi saya untuk terus mempelajari autisme, TEACCH dan MIKA 1.0 sebagai alat bantu belajar komunikasi pada individu autistik
                                            </h2>
                                            @foreach([
                                                'Sama sekali tidak puas (1)',
                                                'Tidak terlalu puas (2)',
                                        ...
                                        <div class="">
                                            <h2 class="mb-2">
                                                4. Asesmen yang dilakukan di MIKA education berguna dalam memberikan informasi/umpan balik mengenai kemampuan saya memahami MIKA 1.0
                                            </h2>
                                            @foreach([
                                                'Sama sekali tidak puas (1)',
                                                'Tidak terlalu puas (2)',
                                        ...
                                        <div class="">
                                            <h2 class="mb-2">
                                                5. Saya mampu melakukan komunikasi dan diskusi dengan rekan-rekan belajar lainnya di MIKA education, dan hal ini bermanfaat bagi kelanjutan belajar saya ke depan
                                            </h2>
                                            @foreach([
                                                'Sama sekali tidak puas (1)',
                                                'Tidak terlalu puas (2)',
