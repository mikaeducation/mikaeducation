                        ...
                        <div class="space-y-4 border-2 border-bluee3" style="direction: ltr;">
                            <div class="w-full h-fit flex p-2 bg-bluee3">
                                <p class="text-base whitespace-pre-line"><span class="font-bold">Bagian 3 -</span> Kepuasan penggunaan MIKA Education sebagai sumber belajar
                                    Intruksi: <span class="font-medium">  Dari skala 1-5, sejauh mana kalimat-kalimat di bawah ini sesuai menjelaskan kemampuan Anda mengadministrasi MIKA 1.0 setelah menggunakan materi belajar MIKA 1.0 di website MIKA education?</span>
                                </p>
                            </div>
                            <div class="w-full space-y-4 pl-2 pb-2 text-base">
                                <div class="w-full text-blue31">
                                    ...
                                    <form action="/preLearn_1" method="" class="space-y-4">
                                        ...
                                        <div class="">
                                            <h2 class="mb-2">
                                                1. Saya mudah melakukan registrasi terapis dan anak
                                            </h2>
                                            @foreach([
                                        ...
                                        <div class="">
                                            <h2 class="mb-2">
                                                2. Saya mudah memahami fungsi-fungsi yang ada di MIKA 1.0
                                            </h2>
                                            @foreach([
                                                'Sama sekali tidak puas (1)',
                                                'Tidak terlalu puas (2)',
                                        ...
                                        <div class="">
                                            <h2 class="mb-2">
                                                3. Saya memahami tahapan dan administasi belajar komunikasi I hingga IV di MIKA 1.0
                                            </h2>
                                            @foreach([
                                                'Sama sekali tidak puas (1)',
                                                'Tidak terlalu puas (2)',
                                        ...
                                        <div class="">
                                            <h2 class="mb-2">
                                                4. Saya bisa melakukan skoring dan menyimpan data progress anak
                                            </h2>
                                            @foreach([
                                                'Sama sekali tidak puas (1)',
                                                'Tidak terlalu puas (2)',
                                        ...
                                        <div class="">
                                            <h2 class="mb-2">
                                                5. Saya bisa mengakses kembali data yang tersimpan di MIKA 1.0 dengan mudah
                                            </h2>
                                            @foreach([
                                                'Sama sekali tidak puas (1)',
                                                'Tidak terlalu puas (2)',
