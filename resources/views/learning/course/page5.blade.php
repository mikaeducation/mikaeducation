            ...
            <div id="left" class="h-full w-1/4 mr-8 sticky top-0 transition-all duration-300">
                <div id="leftContent" class="w-full h-fit flex flex-col justify-between items-start space-y-5">
                    ...
                    <div class="mt-8 w-full h-fit text-base text-blue31 font-medium space-y-1">
                        <div class="w-full h-5 rounded-full bg-bluee3 flex-col"><div class="w-16 h-full bg-blue31 rounded-l-full"></div></div>
                        <p>29% Progress selesai</p>
                    </div>
                                    ...
                                    <div class="w-3/4 text-blue31 ">
                                        <div class="w-full h-fit pr-2">
                                            <p class="text-base mb-2">
                                                <Span class="text-base font-bold">Observasi, Pencatatan Karakteristik, Dampak dan Strategi:</Span>
                                                Komunikasi, Interaksi Sosial, Perilaku, Bermain, Pemrosesan Informasi, Sensoris dan Motorik
                                            </p>
                    ...
                    <div class="h-full w-full mt-8 pl-8 space-y-8 overflow-y-scroll scrollbar scrollbar-thumb scrollbar-thumb-rounded scrollbar-thumb-gray-300 scrollbar-track-gray-100" style="direction: rtl;">
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full text-blue31 pb-4 border-b-2 border-bluee3 text-justify"  style="direction: ltr;">
                                <p class="mt-5"><span class=" whitespace-pre-line">Hi saya Mida, 
                                    Pada materi sebelumnya kita semua telah belajar apa itu autisme dengan bu Margaretha
                                    kita semua telah mengetahui bahwasanya anak dengan autisme memiliki karakteristik yang cukup komplek dan untuk mempermudah kita semua untuk memahami lebih detil bagaimana karakteristik autisme itu sendiri maka kita memerlukan sebuah dokumen yang kita sebut matriks perencanaan.

                                    oke, sekarang kita akan masuk pada materi matriks perencanaan, <span class="font-medium">definisi</span> matriks perencanaan merupakan sebuah dokumen yang dapat digunakan oleh orang tua, guru dan professional untuk memfoto keadaan anak dengan autism. apa saja yang ada di dalam matriks perencanaan?  yaitu karakteristik anak dimulai dari karakteristik komunikasi yang terbagi menjadi empat yaitu ketrampilan pendahuluan, komunikasi ekspresif dan reseptif, dan pragmatisme, kemudian interaksi sosial, tahapan dan tipe bermain. selanjutnya adalah karakteristik perilaku berulang dan minat terbatas, proses informasi, proses sensori serta motorik. Garis besarnya adalah matriks ini merupakan suatu alat untuk mengukur anak secara utuh, ibarat memilih baju kita akan membuat ukuran yang sangat pas sehingga nyaman untuk dipakai.

                                    Terkait dengan matriks ini, <span class="font-medium">siapa saja</span> yang bisa mengisi matriks perencanaan: nah, untuk pengisian matriks ini dilakukan oleh tim yang terdiri dari orang tua, guru dan tenaga professional seperti psikolog klinis, dokter anak dan juga psikiater. Kenapa harus dilakukan oleh tim karena kita semua akan mendapatkan gambaran yang sangat lengkap, selain itu juga dapat membantu kita untuk bisa menghindari penilaian secara subjektif.

                                    <span class="font-medium">Kapan dilaksanakan:</span> kapan kita bisa mengisi matriks perencanaan, yaitu di waktu 6-8 minggu pertama di awal semester. Namun, pada proses pelaksanaan intervensi jika anak telah menunjukkan perkembangan maka matriks perencanaan ini juga akan mengikuti, artinya matriks ini berubah mengikuti perkembangan anak. 

                                    <span class="font-medium">Kenapa perlu matriks perencanaan:</span> hal ini dilakukan untuk meningkatkan pemahaman tentang diri anak secara menyeluruh, membantu mengidentifikasi tujuan yang menjadi prioritas, menjadi bahan pendukung yang dapat disampaikan kepada sekolah jenjang berikutnya sehingga strategi pengajaran tidak terputus. 

                                    <span class="font-medium">Bagaimana cara mengisinya,</span> untuk melengkapai matriks ini secara berurutan adalah dengan melengkapi karakteristik secara menyeluruh di tiap-tiap karakteristik anaknya, apa yang sudah anak mampu lakukan dan juga hal apa yang masih perlu dikembangkan, kemudian setelah karakteritik adalah mengisi dampak yang muncul, perlu dipertimbangkan dampak yang muncul adalah bagaimana ke anak itu sendiri, bagaimana dampak ke orang lain, ke lingkungan sekolah, bagaimana dampak ke masyarakat hingga masa depan anak. Setelah dampak terpenuhi maka baru mengisi strategi, nah dalam pengisian strategi ini akan jauh lebih terukur jika kita semua telah mengetahui bagaimana dampak yang muncul sehingga strategi yang diberikan sesuai dengan yang dibutuhkan oleh anak. hal yang sangat perlu diingat adalah jangan mengisi karakteristik kemudian langsung strategi. Nah, untuk mengisinya kita menggunakan tanda (+,0 dan juga -), dimana ‘+’ ini artinya anak mampu melakukan, sedangkan ‘0’ anak masih dalam bantuan dan ‘-’ anak masih belum mampu untuk melakukan.
                                </p>
                            </div>
                            {{-- Navigasi --}}
                            <div class="w-3/4 space-x-10 mt-8 flex justify-end items-center"  style="direction: ltr;">
                                <a href="/page4_4" class="text-base flex text-blue31 font-semibold">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" fill="#6AA4D9" viewBox="0 0 24 24">
                                ...
                                <a href="/page6" class="text-base flex text-blue31 font-semibold">Selanjutnya
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" fill="#6AA4D9" viewBox="0 0 24 24">
                                        <path d="M8.293 4.707a1 1 0 0 1 1.414 0L16.707 12l-6.293 7.293a1 1 0 0 1-1.414-1.414L14.586 12 8.293 6.121a1 1 0 0 1 0-1.414z" />
                                    </svg>
                                </a>
