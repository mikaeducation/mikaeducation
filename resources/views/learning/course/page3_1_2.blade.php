                    ...
                    <div class="h-full w-full space-y-8">
                            ...
                            <div class="w-full h-full flex justify-center items-center">
                                <div class="aspect-w-16 aspect-h-9 w-full h-full flex justify-center items-center">
                                    @include('includes.content.elearning.course.video-player', [
                                        'src' =>
                                            'https://s3-id-jkt-1.kilatstorage.id/belajar-komunikasi-autistik/modul-3c-komunikasi-reseptif.mp4',
                                    ])
                                </div>
                            </div>
                        </div>
                        <div class="w-full py-8 border-y-2 border-bluee3 space-y-4 text-lg">
                            <div class="w-full flex flex-col text-justify">
                                <p>
                                <p class="p-2 bg-bluee3 mb-2"><span class="font-medium">Karakteristik Reseptif</span> - Komunikasii Reseptif
                                ...
                                foto, instruksi. Memahami sesuatu yang ditanyakan dan cara menjawab dengan ya/tidak, menjawab pertanyaan konsep
                                siapa, apa, kapan, Dimana,
                                kenapa dan bagaimana dan juga memahami suatu konsep nomor, bentuk, emosi dan juga lainnya. Kemampuan reseptif
                                ini yaitu bereaksi terhadap nama,
                                memahami label/nama untuk benda umum/orang, mengikuti perintah sederhana seperti duduk, jauhi, kemampuan dalam
                                menjawab pertanyaan dasar dan mampu untuk memecahkan masalah.
                                <br><br>Pada kemampuan ini, anak autistik kesulitan untuk memahami pertanyaan yang bervariasi. Kesulitan
                                memahami suatu konsep bahasa abstrak seperti peribahasa, idiom, majas, padan kata, atau sinonim, maupun lawan
                                kata atau antonim untuk membantu komunikasi reseptif pada anak autistik bisa menggunakan alat bantu visual.
                                <br><br>Baik terima kasih. Kita sudah membahas komunikasi reseptif, berikutnya kita akan belajar tentang
...
<x-elearning.course.interactive.popup-question.reset-button videoId=4 userId="{{ Auth::id() }}" moduleId=1 />
