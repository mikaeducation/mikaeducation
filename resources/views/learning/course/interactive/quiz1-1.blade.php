    ...
    <section class="w-full flex flex-grow items-start justify-start">
        ...
        <div id="js-scene-1" class="quiz-section h-[85vh] flex flex-col flex-grow">
            ...
            <form class="x-5 py-3 w-1/3 flex justify-stretch self-end">
                ...
                <div onclick="submitQuiz('{{ route('quiz.post', ['quiz_id' => $quiz_id]) }}')"  class="w-full m-2 p-2 text-white text-center bg-blue31 rounded transition hover:-translate-y-1 hover:scale-105">
                    Kumpulkan
                </div>
            </form>
        </div>
