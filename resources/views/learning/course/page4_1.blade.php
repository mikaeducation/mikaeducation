                ...
                <div class="w-full h-full flex flex-col" style="direction: ltr;">
                    <div class="flex items-center h-10">
                        ...
                        <div class="text-base flex ml-4 md:ml-8 lg:ml-12 text-blue31 font-bold" style="display: inline-flex; flex-wrap: wrap;">
                            ...
                            <a href="/course" class="flex">
                                <span>Komunikasi Ekspresif</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" fill="#6AA4D9" viewBox="0 0 24 24">
                                    <path d="M8.293 4.707a1 1 0 0 1 1.414 0L16.707 12l-6.293 7.293a1 1 0 0 1-1.414-1.414L14.586 12 8.293 6.121a1 1 0 0 1 0-1.414z" />
                                </svg>
                            </a>
                    ...
                    <div class="h-full w-full mt-8 pl-8 space-y-8 overflow-y-scroll scrollbar scrollbar-thumb scrollbar-thumb-rounded scrollbar-thumb-gray-300 scrollbar-track-gray-100" style="direction: rtl;">
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full text-blue31 pb-4 border-b-2 border-bluee3 text-justify"  style="direction: ltr;">
                                <p class="mt-7 p-2 bg-bluee3"><span class="font-medium">Karakteristik Ekspresif</span> - Komunikasii Ekspresif Anak dengan Autimse</p>                        
                                <p class="mt-2 whitespace-pre-line">Kita lanjutkan pembahasan tentang karakteristik komunikasi ya. Sebelumnya sudah kita bahas karakteristik pra – komunikasi atau keterampilan pendahuluan yang menjadi tahapan dasar  dalam berkomunikasi. Selanjutnya, mari kita bahas tentang karakteristik bahasa ekspresif. Tahapan berikutnya adalah : 

                                    <span class="font-medium"> Komunikasi eskpresif</span>K adalah kemampuan untuk mengekspresikan keinginan, ide dan kebutuhan kepada orang lain.  Bagaimana anak autis bisa menyampaikan informasi kepada orang lain. Karakteristik utama komunikasi ekspresif adalah  menggunakan suara, kata dalam bentuk kata tunggal, kata pendek dan kalimat. Bagaimana anak bisa melakukan ketrampilan percakapan dengan aktif, berinteraksi dengan berbagai macam topik, pikiran dan perasaan. Yang termasuk dalam komunikasi ekspresif ini adalah: membuat suara, menggunakan kata tunggal, menggunakan kombinasi dua hingga tiga kata, berbicara dalam kalimat, echolalia (mengulang kata atau kalimat yang diucapkan seseorang), mengajukan pertanyaan, membuat komentar dan melakukan ketrampilan percakapan.  
                                    
                                    Pada kemampuan ini anak dengan autism kesulitan untuk meminta sehingga muncul perilaku menangis, menuju atau ke arah yang diinginkan, menggandeng orang lain untuk mencapai yang diinginkan, kesulitan dalam memahami kosa kata atau penggunaan kata secara umum dan juga muncul ecolalia-pada konsep ecolalia ini kita dapat menilai bahwa ecolalia ini bisa menjadi fungsional yang artinya anak akan bisa dianggap bisa meniru hingga menyampaikan apa yang diinginkan secara verbal, bukan hanya sebagai perilaku yang harus dihilangkan. Kesulitan juga ketika melakukan ketrampilan dalam percakapan, bagaimana muncul inisiatif, mempertahankan hingga melakukan penutupan dalam suatu percakapan.
                                </p>
                            </div>
                            {{-- Navigasi --}}
                            <div class="w-3/4 space-x-10 mt-8 flex justify-end items-center"  style="direction: ltr;">
                                ...
                                <a href="/page4_2" class="text-base flex text-blue31 font-semibold">Selanjutnya
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" fill="#6AA4D9" viewBox="0 0 24 24">
                                        <path d="M8.293 4.707a1 1 0 0 1 1.414 0L16.707 12l-6.293 7.293a1 1 0 0 1-1.414-1.414L14.586 12 8.293 6.121a1 1 0 0 1 0-1.414z" />
                                    </svg>
                                </a>
