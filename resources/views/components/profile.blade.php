                ...
                <div class="w-full h-full flex justify-between items-center py-4">
                    ...
                    <div class="w-full h-full flex pr-4 md:pr-10">
                        <div class="w-full flex flex-wrap justify-end items-center ">
                            ...
                            <a href="" class="w-auto md:w-1/5 p-2 md:p-2 mx-2 md:mx-5 mt-1 md:mt-0 rounded-full flex items-center justify-center text-white font-medium text-lg bg-blue6a hover:bg-pinkee">Analisi Pembelajaran</a>
