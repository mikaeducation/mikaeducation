<div class="flex min-h-screen items-center justify-center p-4 text-center sm:p-0">
    <div class="w-full relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
        ...
        <div class="bg-bluee3 w-full bg-opacity-40 px-4 py-3 flex justify-center space-x-4 sm:px-6">
            <button id="cancelBtn" type="button" class="inline-flex w-1/3 justify-center rounded-full border-2 border-blue31 px-3 py-2 text-base font-semibold text-blue31 shadow-sm transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110">
                Kembali
            </button>
            <button id="startLearningBtn" type="button" class="inline-flex w-1/3 justify-center rounded-full bg-blue31 hover:border-2 hover:border-blue31 px-3 py-2 text-base font-semibold text-white transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110">
                Mulai
            </button>
        </div>
    </div>
