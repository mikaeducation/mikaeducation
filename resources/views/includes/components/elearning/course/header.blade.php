...
<header class="w-full h-16 content-shadows flex justify-center items-center sticky top-0 z-50 bg-white text-blue6a">
    <div class="flex justify-between items-center h-full w-[95%]">
        <div class="flex justify-start items-center mr-auto w-[80%]">
            <div class="w-fit h-8 flex items-center justify-start gap-3">
                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-7 h-7">
                    <path d="M20.9534 12V17C20.9534 18.8856 20.9534 19.8284 20.3676 20.4142C19.7818 21 18.839 21 16.9534 21H7.45337C6.07266 21 4.95337 19.8807 4.95337 18.5V18.5C4.95337 17.1193 6.07266 16 7.45337 16H16.9534C18.839 16 19.7818 16 20.3676 15.4142C20.9534 14.8284 20.9534 13.8856 20.9534 12V7C20.9534 5.11438 20.9534 4.17157 20.3676 3.58579C19.7818 3 18.839 3 16.9534 3H8.95337C7.06775 3 6.12494 3 5.53916 3.58579C4.95337 4.17157 4.95337 5.11438 4.95337 7V18.5" stroke="#6AA4D9" stroke-width="2"/>
                    <path d="M9.95337 10L11.2463 11.2929C11.6368 11.6834 12.27 11.6834 12.6605 11.2929L15.9534 8" stroke="#6AA4D9" stroke-width="2" stroke-linecap="round"/>
                </svg>                         
                <h3 class="font-medium text-lg">Belajar Komunikasi Autisme dengan MIKA</h3>
            </div>
        </div>
        <div class="text-lg text-blue6a font-medium tracking-wide w-[20%]">
            <nav class="w-full h-full relative flex items-center justify-end">
                <button id="menu-toggle" class="w-7 h-7">
                    <svg fill="#6AA4D9" height="30" width="30" stroke="#6AA4D9" stroke-width="2" class="w-full h-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 54 54" xml:space="preserve"><g>
                        ...
                        <path d="M27,18c-4.963,0-9,4.037-9,9s4.037,9,9,9s9-4.037,9-9S31.963,18,27,18z M27,34c-3.859,0-7-3.141-7-7s3.141-7,7-7 s7,3.141,7,7S30.859,34,27,34z"/></g>
                    </svg>
                </button>
                <div id="dropdown-menu" class="absolute top-8 right-0 mt-2 w-48 bg-transparent content-shadows rounded-md hidden">
                    <div class="absolute top-0 right-1.5 transform translate-y-1 w-6 h-6 z-10 bg-blue6a rotate-45"></div>
                    <div class="w-full absolute z-20 mt-4 bg-blue6a text-white rounded-b rounded-s ">
                        <button id="aksesibilitas-btn" class="block w-full text-left px-4 py-2 hover:bg-white hover:text-blue6a">Aksesibilitas</button>
                        <a href="javascript:void(0)" id="startButton" class="block w-full text-left px-4 py-2 hover:bg-white hover:text-blue6a">
                            Keluar Pembelajaran
                        </a>
                    </div>
                </div>
                    @include('includes.components.elearning.course.dialog.learn-out')
                <div id="dropdown-aksesibilitas" class="absolute top-8 right-0 mt-2 w-72 sm:w-96 bg-white content-shadows rounded hidden">
                    <div class="absolute w-full h-fit z-20 mt-4 pt-2 pb-4 bg-white content-shadows text-blue31 rounded">
                        <div class="block w-full text-left px-4 py-2 space-y-2">
                            <h5 class="w-full flex">Tema</h5>
                            <div class="w-full text-blue31 text-sm font-normal flex items-center justify-start gap-5">
                                <div id="default-theme" class="w-full h-fit flex flex-col items-center justify-center gap-1">
                                    <button class="bg-white w-fu ll h-20 p-2 rounded border-blue31 border-2 relative">
                                        <svg width="15" height="15" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="rounded-full bg-blue31 absolute top-1 left-1">
                                            <path d="M12 24L20 32L36 16" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg> 
                                        Belajar dengan MIKA
                                    </button>
                                    <p class="font-medium">Terang</p>
                                </div>
                                <div class="w-full h-fit flex flex-col items-center justify-center gap-1">
                                    <button class="bg-[#ECE1CB] w-full h-20 p-2 rounded border-2 hover:border-blue31 hover:border-2">Belajar dengan MIKA</button>
                                    <p class="font-medium">Hangat</p>
                                </div>
                                <div class="w-full h-fit flex flex-col items-center justify-center gap-1">
                                    <button class="bg-[#3F3F46] w-full h-20 p-2 rounded border-2 text-white hover:border-white hover:border-2">Belajar dengan MIKA</button>
                                    <p class="font-medium">Gelap</p>
                                </div>
                            </div>
                        </div>
                        <div class="block w-full text-left px-4 py-2 space-y-2">
                            <h5 class="w-full flex">Jenis Font</h5>
                            <div class="w-full text-blue31 text-sm font-normal flex items-center justify-start gap-5">
                                <div id="default-font" class="w-full h-fit flex flex-col items-center justify-center gap-1">
                                    <button class="bg-white w-full h-20 p-2 rounded border-blue31 border-2 relative">
                                        <svg width="15" height="15" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="rounded-full bg-blue31 absolute top-1 left-1">
                                            <path d="M12 24L20 32L36 16" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        Default (Futura)
                                ...
                                <div class="w-full h-fit flex flex-col items-center justify-center gap-1">
                                    <button class="bg-white w-full h-20 p-2 rounded border-2 hover:border-blue31 hover:border-2 font-serif">Serif</button>
                                </div>
                                <div class="w-full h-fit flex flex-col items-center justify-center gap-1">
                                    <button class="bg-white w-full h-20 p-2 rounded border-2 text-blue31 hover:border-blue31 hover:border-2 font-sans">Sans</button>
                                </div>
                            </div>
                        </div>
                        <div class="block w-full text-left px-4 py-2 space-y-2">
                            <h5 class="w-full flex">Ukuran Font</h5>
                            <div class="w-full text-blue31 text-sm font-normal flex items-center justify-start gap-5">
                                <div id="default-font" class="w-full h-fit flex flex-col items-center justify-center gap-1">
                                    <button class="bg-white w-full h-20 p-2 rounded border-2 hover:border-blue31 hover:border-2">Kecil</button>
                                </div>
                                <div id="default-size" class="w-full h-fit flex flex-col items-center justify-center gap-1">
                                    <button class="bg-white w-full h-20 p-2 text-base rounded border-blue31 border-2 relative">
                                        <svg width="15" height="15" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="rounded-full bg-blue31 absolute top-1 left-1">
                                            <path d="M12 24L20 32L36 16" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        Sedang
                                ...
                                <div class="w-full h-fit flex flex-col items-center justify-center gap-1">
                                    <button class="bg-white w-full h-20 p-2 rounded border-2 text-blue31 text-xl hover:border-blue31 hover:border-2">Besar</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    const aksesibilitasBtn = document.getElementById("aksesibilitas-btn");
    const dropdownAksesibilitas = document.getElementById("dropdown-aksesibilitas");

    // Tambahkan overlay saat dropdown dibuka
    const overlay = document.createElement("div");
    overlay.classList.add("fixed", "inset-0", "bg-black", "bg-opacity-50", "hidden", "z-30");
    document.body.appendChild(overlay);

    // Tampilkan/hilangkan dropdown pertama saat ikon diklik
    menuToggle.addEventListener("click", function (event) {
        event.stopPropagation();
        const isHidden = dropdownMenu.classList.contains("hidden");

        dropdownMenu.classList.toggle("hidden");
        dropdownAksesibilitas.classList.add("hidden");

        // Tampilkan overlay hanya jika dropdown dibuka
        if (isHidden) {
    ...
    // Tampilkan dropdown Aksesibilitas dan sembunyikan dropdown utama
    aksesibilitasBtn.addEventListener("click", function (event) {
        event.stopPropagation();
        dropdownMenu.classList.add("hidden");
        dropdownAksesibilitas.classList.toggle("hidden");
    });

    // Sembunyikan dropdown dan overlay jika klik di luar menu
    ...
    // Mencegah dropdown aksesibilitas hilang saat diklik di dalamnya
    dropdownAksesibilitas.addEventListener("click", function (event) {
        event.stopPropagation();
    });
