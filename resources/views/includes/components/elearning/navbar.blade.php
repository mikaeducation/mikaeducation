...
<div class="hidden md:flex w-full md:w-1/3 justify-end">
    <button id="menu-btn-lg" class="flex items-center justify-center h-12 w-12 p-2 bg-blue6a rounded-full transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110">
