            ...
            <div class="w-full h-fit flex flex-col items-start justify-start mt-20">
                ...
                <div id="content1.1" class="w-full">
                    ...
                    <div class="w-full h-fit space-y-6 text-blue31">
                        ...
                        <div class="w-full h-full lg:flex items-center justify-center text-base lg:text-lg gap-5 grid grid-cols-2">
                            <div class="w-full lg:w-1/4 h-fit lg:h-80 bg-bluee3 flex flex-col items-center text-justify p-4 lg:pt-8 gap-4">
