...
<div class="w-full lg:border-l-8 border-gray-100 pl-0 lg:pl-10 mt-0 lg:mt-8">
    <div class="space-y-8">
        ...
        <div class="flex flex-col md:flex-row w-full h-max gap-8 px-8 py-8 bg-bluee3 text-lg font-medium">
            ...
            <div class="w-full flex items-end md:justify-end">
                <a href="javascript:void(0)" id="startButtonNow2" class="text-white w-3/4 md:w-3/4 lg:w-2/3 flex justify-center items-center text-center transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110">
    ...
    <div class="w-full space-x-10 mt-14 flex justify-end items-center">
        ...
        <a href="javascript:void(0)" id="startButtonNext2" class="text-base flex text-blue31 font-semibold">Selanjutnya
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" fill="#6AA4D9" viewBox="0 0 24 24">
...
<!-- Form dialog -->
<div id="modalDialog2" class="relative z-50 hidden w-3/4 md:w-0" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 z-10 w-full md:w-screen overflow-y-auto">
        @include('includes.components.elearning.course.dialog.startAsessmen2_0mob')
    </div>
</div>
