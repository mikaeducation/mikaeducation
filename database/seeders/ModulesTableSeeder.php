...
class ModulesTableSeeder extends Seeder
{
    public function run()
    {
        DB::table('modules')->insert([
            [
                'module_title' => 'Komunikasi dengan Anak Autistik menggunakan MIKA 1.0',
                ...
                'module_publisher_logo' => 'modules/logos/logo-1.png',
                'module_publisher_name' => 'Media Visual Komunikasi Anak',
                'module_publisher_banner' => 'modules/banners/bg5.jpg',
                ...
                'module_duration' => '150', // dalam menit
                ...
                'module_certificate' => 'modules/certificates/sample-sertificate.png',
                'module_teaser' => 'modules/teasers/MIKA-tesear.mp4',
